...
<div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <h2 style="text-align: center; color: #333; margin-bottom: 20px;">Create New Food</h2>
    <form action="../CreateFoodServlet" method="post">
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" id="name" name="name" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; box-sizing: border-box;">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="description" style="display: block; font-weight: bold; margin-bottom: 5px; color: #555;">Description:</label>
            <input type="text" id="description" name="description" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; box-sizing: border-box;">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="price" style="display: block; font-weight: bold; margin-bottom: 5px; color: #555;">Price:</label>
            <input type="text" id="price" name="price" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; box-sizing: border-box;">
        </div>
        <!-- Hidden field to pass RestaurantId -->
        <input type="hidden" id="restaurantId" name="restaurantId" value="<%=restaurantId%>">
        <div style="margin-bottom: 15px;">
            <label for="imagePath" style="display: block; font-weight: bold; margin-bottom: 5px; color: #555;">Image Path:</label>
            <input type="text" id="imagePath" name="imagePath" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; box-sizing: border-box;">
        </div>
        <div style="text-align: center;">
            <input type="submit" value="Create Food" style="background-color: #4CAF50; color: #fff; padding: 12px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; font-weight: bold; transition: background-color 0.3s ease;">
        </div>
    </form>
</div>

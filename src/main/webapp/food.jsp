		...
		<div class="container-fluid">
			<div
				...
				<h1
					...
					Life is food, I'm always hungry!</h1>
...
<div style="text-align: center; margin-top: 30px;">
    ...
    " onfocus="this.style.borderColor='#81C784'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.2)';" onblur="this.style.borderColor='#4CAF50'; this.style.boxShadow='0 4px 6px rgba(0, 0, 0, 0.1)';">
    ...
    " onmouseover="this.style.backgroundColor='#45a049'; this.style.boxShadow='0 6px 8px rgba(0, 0, 0, 0.2)';" onmouseout="this.style.backgroundColor='#4CAF50'; this.style.boxShadow='0 4px 6px rgba(0, 0, 0, 0.1)';">
        Search
    </button>
</div>
</form> -->
		...
		<div
			...
			<%
			try {
				// Updated SQL query with join to include Restaurant Name
				String query = "SELECT f.Id, f.Name, f.Description, f.Price, f.RestaurantId, f.ImagePath, r.Name AS RestaurantName "
			...
			<div
				...
				<div style="padding: 10px;">
					<figure style="margin: 0; border-radius: 12px; overflow: hidden;">
						<img src="<%=resultSet.getString("ImagePath")%>" alt="Ocean View Room"
				...
				<div style="padding: 20px; background-color: #f9f9f9;">
					...
					<table
						...
						<tr style="border-bottom: 1px solid #ddd;">
							...
							<td style="padding: 8px;"><%=resultSet.getString("RestaurantName")%></td>
						</tr>
						<tr style="border-bottom: 1px solid #ddd;">
			...
			<!-- Repeat the above card for additional items -->

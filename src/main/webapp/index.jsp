...
<html lang="en">
 ...
 <div class="container">
    ...
    <nav id="main-menu" class="main-menu">
      <ul class="menu">
        ...
        <li class="menu-item menu-btn">
          ...
          <li class="menu-item">
            <a class="signup-nav signuplink " href="signup.jsp">SIGN UP</a>
          </li>
      </ul>
    </nav>
  </div>
  ...
  <!-- ========== REVOLUTION SLIDER ========== -->
  <div class="slider" style="background-color: #2b2b2b; color: #f1c40f; position: relative; overflow: hidden; display: flex; justify-content: center; align-items: center; height: 100vh;">
    ...
    <div id="rev-slider-7" class="rev_slider color-slider gradient-slider op5"  style="display:none;" data-version="5.4.5">
     ...
     >
<video class="rs-background-video-layer" autoplay muted loop id="myVideo" style="
  position: fixed; 
  width: 100%; 
  height: 100%; 
  object-fit: cover; 
...
<div style="
  ...
  z-index: 0;">
    ...
    Indulge in a dining experience that brings your culinary dreams to life. <br/>
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="info-branding">
            <p>
            Welcome to ABC RESTURENT, where every meal is a masterpiece. Immerse yourself in our unique dining experience, where farm-to-table freshness meets innovative culinary artistry. From our signature dishes crafted with love to our inviting ambiance, we promise a memorable dining adventure for every palate. Discover your new favorite spot and savor the flavors that tell a story in every bite. Your table is waiting join us today!
             </p>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="images/abc.jpg" class="img-fluid" alt="Image">
                  </a>
 ...
 <section class="info services-v2 ">
  ...
  <div class="container-fluid">
    <div class="parallax-image">
        ...
        <h5>Indulge in a dining experience that brings your culinary dreams to life. <br> Every dish is crafted to inspire and delight,<br> making every meal a journey of flavor and imagination.
           </h5>
    </div>
</div>
</section>
          ...
          <div class="owl-carousel testimonials-owl">
            ...
            <div class="item">
              <div class="testimonial-item">
                ...
                <h6 style="letter-spacing: 1px;">Indulge in a dining experience that brings your culinary dreams to life. Every dish is crafted to inspire and delight, making every meal a journey of flavor and imagination.</h6>
              </div>
            </div>
            <!-- ITEM -->
            <div class="item">
